...
async function generateWebsite(business) {
    try {
        ...
        if (!resp.ok) {
            ...
            throw new Error(`Generate failed: ${resp.status} ${resp.statusText} ${text}`);
        }
        ...
        const isHospitality = category.includes("restaurant") ||
            category.includes("cafe") ||
            category.includes("bakery");
        const isWellness = category.includes("salon") ||
            category.includes("spa") ||
            category.includes("wellness");
        const isFitness = category.includes("gym") ||
            category.includes("fitness") ||
            category.includes("training");
        const isProfessional = category.includes("law") ||
