...
// src/lib/brand-identity-engine.ts
var brand_identity_engine_exports = {};
__export(brand_identity_engine_exports, {
  generateBrandDNA: () => generateBrandDNA,
  getPaletteForDNA: () => getPaletteForDNA
});
function generateBrandDNA(category) {
...
var PALETTES;
var init_brand_identity_engine = __esm({
  "src/lib/brand-identity-engine.ts"() {
    PALETTES = {
      "luxury-dark": {
        background: "#07070a",
...
// src/lib/typography-system.ts
var typography_system_exports = {};
__export(typography_system_exports, {
  getTypographyForDNA: () => getTypographyForDNA
});
function getTypographyForDNA(dna) {
  return FONT_PAIRS[dna.typographyMood] || FONT_PAIRS.minimal;
}
var FONT_PAIRS;
var init_typography_system = __esm({
  "src/lib/typography-system.ts"() {
    FONT_PAIRS = {
      elegant: {
...
`);
    ...
    const { generateBrandDNA: generateBrandDNA2, getPaletteForDNA: getPaletteForDNA2 } = await Promise.resolve().then(() => (init_brand_identity_engine(), brand_identity_engine_exports));
    const { getTypographyForDNA: getTypographyForDNA2 } = await Promise.resolve().then(() => (init_typography_system(), typography_system_exports));
    const dna = generateBrandDNA2(business.category || "Local Business");
    const palette = getPaletteForDNA2(dna);
    const typography = getTypographyForDNA2(dna);
